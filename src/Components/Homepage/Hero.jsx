...
function Hero() {
  ...
  return (
    <div>
        ...
        >
          <img
            src="/background image homepage.jpeg"
            className="w-full z-[-1] h-full absolute top-0 right-0 object-cover self-center"
            alt=""
          />
          <div className=" bg-[rgba(0,0,0,.5)] text-white w-full h-full flex px-4 flex-col items-center justify-center ">
            <h1 className="font-semibold lg:text-5xl pt-12 md:text-4xl text-3xl">
              Transform your Digital presence with Tovutisha.
            </h1>
            <p className="lg:text-2xl text-md mt-10 text-xl md:text-lg">
            Modern Solutions for Schools,Firms and Organizations.
            </p>{" "}
          </div>
        </div>
    </div>  
